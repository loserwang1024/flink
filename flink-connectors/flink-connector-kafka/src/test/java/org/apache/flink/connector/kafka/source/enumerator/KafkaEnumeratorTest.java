...
public class KafkaEnumeratorTest {
    ...
    public void testSnapshotState() throws Throwable {
        try (MockSplitEnumeratorContext<KafkaPartitionSplit> context =
            ...
            // Step2: first partition discovery after start
            ...
            // Step3: after assign partition to reader0 and reader1
            context.runNextOneTimeCallable();

            // The state should contain splits assigned to READER0 and READER1, but no READER2
            // register.
            // Thus, both assignedPartitions and unassignedInitialPartitons is not empty.
            final KafkaSourceEnumState state3 = enumerator.snapshotState(1L);
            ...
            // state3 only includes unassignedInitialPartitons + assignedPartitions
            ...
            // Step4: register READER2, then all partition are assigned
            registerReader(context, enumerator, READER2);
            final KafkaSourceEnumState state4 = enumerator.snapshotState(1L);
